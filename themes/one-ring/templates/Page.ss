...
<head>
  ...
  <title>$Title</title>
	...
	<!-- Modernizr -->
	<script src="$ThemeDir/javascript/common/modernizr.js"></script>
</head>
<body>
	<!-- BEGIN WRAPPER -->
	<div id="wrapper">
	...
	<script type="text/javascript" src="$ThemeDir/javascript/common/jquery-1.11.1.min.js"></script>
	<script type="text/javascript" src="$ThemeDir/javascript/common/bootstrap.min.js"></script>
	<script type="text/javascript" src="$ThemeDir/javascript/common/bootstrap-datepicker.js"></script>
	<script type="text/javascript" src="$ThemeDir/javascript/common/chosen.min.js"></script>
	<script type="text/javascript" src="$ThemeDir/javascript/common/bootstrap-checkbox.js"></script>
	<script type="text/javascript" src="$ThemeDir/javascript/common/nice-scroll.js"></script>
	<script type="text/javascript" src="$ThemeDir/javascript/common/jquery-browser.js"></script>
